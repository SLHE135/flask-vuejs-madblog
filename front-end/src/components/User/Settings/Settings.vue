          ...
          <ul class="list-unstyled mb-0">
            ...
            <li class="g-py-3">
              <router-link
                class="d-block align-middle u-link-v5 g-color-text g-color-primary--hover g-bg-gray-light-v5--hover rounded g-pa-3"
                v-bind:active-class="'active g-color-primary--active g-bg-gray-light-v5--active'"
                v-bind:to="{ name: 'SettingAccount' }">
                <span class="u-icon-v1 g-color-gray-dark-v5 mr-2"><i
                  class="icon-medical-071 u-line-icon-pro"></i></span>
                Account
              </router-link>
            </li>
            <li class="g-py-3">
            ...
            <li class="g-py-3">
              <router-link
                class="d-block align-middle u-link-v5 g-color-text g-color-primary--hover g-bg-gray-light-v5--hover rounded g-pa-3"
                v-bind:active-class="'active g-color-primary--active g-bg-gray-light-v5--active'"
                v-bind:to="{ name: 'SettingNotification' }">
                <span class="u-icon-v1 g-color-gray-dark-v5 mr-2"><i
                  class="icon-electronics-031 u-line-icon-pro"></i></span>
                Notification
              </router-link>
            </li>
          </ul>
