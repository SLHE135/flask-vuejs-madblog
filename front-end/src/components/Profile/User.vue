      ...
      <div class="g-brd-around g-brd-gray-light-v4 g-pa-20 g-mb-40">
        <div class="row">
          <div class="col-sm-3 g-mb-40 g-mb-0--lg">
            <!-- User Image -->
            <div class="g-mb-20">
              <img v-if="user._links.avatar" class="img-fluid w-100 g-brd-around g-brd-gray-light-v4 g-pa-2"
            ...
            <router-link v-if="$route.params.id != sharedState.user_id"
                         class="btn btn-block u-btn-outline-purple g-rounded-50 g-py-12 g-mb-10"
                         v-bind:to="{ name: 'MessagesHistoryResource', query: { from: $route.params.id } }">
          ...
          <div class="col-sm-9">
            ...
            <ul class="nav nav-tabs g-mb-20">
              <li class="nav-item">
                <router-link class="nav-link" v-bind:active-class="'active'" v-bind:class="isUserOverView"
                             v-bind:to="{ name: 'UserOverview' }">Overview <span
                  class="u-label g-font-size-11 g-bg-primary g-rounded-20 g-px-10"><i
                  class="icon-layers g-pos-rel g-top-1 g-mr-8"></i></span></router-link>
              </li>
              <li class="nav-item">
              ...
              <li class="nav-item">
                <router-link class="nav-link" v-bind:active-class="'active'" v-bind:to="{ name: 'UserFollowing' }">
                  Following <span class="u-label g-font-size-11 g-bg-aqua g-rounded-20 g-px-10">{{
