  ...
  <div>
    ...
    <div class="card border-0 g-mb-15">
      ...
      <div class="card-header d-flex align-items-center justify-content-between g-bg-gray-light-v5 border-0 g-mb-15">
        <h3 class="h6 mb-0">
          <i class="icon-bubbles g-pos-rel g-top-1 g-mr-5"></i> Liked Posts <small v-if="posts">(共
      ...
      <div v-if="posts" class="card-block g-pa-0">
        ...
        <div v-for="(post, index) in posts.items"
             v-bind:key="index" class="media g-brd-around g-brd-gray-light-v4 g-brd-left-1 g-pa-20 g-mb-20">
          ...
          <div class="media-body">
            <div class="g-mb-15">
              <h5 class="h5 g-color-gray-dark-v1 mb-0">
                ...
                <span class="h6 g-color-aqua">的文章<router-link class="g-text-underline--none--hover"
              ...
              <ul class="list-inline mb-0">
                ...
                <li class="list-inline-item g-mr-20">
                  <router-link class="g-color-gray-dark-v5 g-text-underline--none--hover"
                               v-bind:to="{ path: `/post/${post.id}#like-post` }">
                    <i class="icon-heart g-pos-rel g-top-1 g-mr-3"></i> {{ post.likers_count }}
                  </router-link>
                </li>
                <li class="list-inline-item g-mr-20">
                  <router-link class="g-color-gray-dark-v5 g-text-underline--none--hover"
                               v-bind:to="{ path: `/post/${post.id}#comment-list-wrap` }">
