  ...
  <div class="container">
    ...
    <form @submit.prevent="onSubmit">
      <div class="form-group" v-bind:class="{'u-has-error-v1': changePasswordForm.oldPasswordError}">
        ...
        <input id="oldPassword" v-model="changePasswordForm.oldPassword" class="form-control" placeholder=""
               type="password">
        <small v-show="changePasswordForm.oldPasswordError"
               class="form-control-feedback">{{ changePasswordForm.oldPasswordError }}</small>
      </div>
      <div class="form-group" v-bind:class="{'u-has-error-v1': changePasswordForm.newPasswordError}">
        <label for="newPassword">New Password</label>
        <input id="newPassword" v-model="changePasswordForm.newPassword" class="form-control" placeholder=""
               type="password">
        <small v-show="changePasswordForm.newPasswordError"
               class="form-control-feedback">{{ changePasswordForm.newPasswordError }}</small>
      </div>
