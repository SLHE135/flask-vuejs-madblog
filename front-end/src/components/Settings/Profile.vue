  ...
  <div>
    ...
    <form @submit.prevent="onSubmit">
      <div class="form-group">
        ...
        <input id="name" v-model="profileForm.name" class="form-control" placeholder="" type="text">
      </div>
      <div class="form-group">
        <label for="location">Location</label>
        <input id="location" v-model="profileForm.location" class="form-control" placeholder="" type="text">
      </div>
      <div class="form-group">
        <label for="about_me">About Me</label>
        <textarea id="about_me" v-model="profileForm.about_me" class="form-control" placeholder="" rows="5"></textarea>
      </div>
