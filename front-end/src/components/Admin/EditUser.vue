  ...
  <div>
    ...
    <form @submit.prevent="onSubmit">
      <div v-if="user" class="form-group">
        ...
        <input id="username" class="form-control form-control-md rounded-0" disabled="" type="text"
      ...
      <div class="form-group">
        ...
        <label class="form-check-inline u-check g-mr-20 mx-0 mb-0">
          <input id="confirmed" v-model="checked" class="g-hidden-xs-up g-pos-abs g-top-0 g-right-0" name="confirmed"
                 type="checkbox">
      ...
      <div class="form-group">
        ...
        <div>
          <!-- Inline Radios -->
          <label v-for="(role, index) in roles.items" v-bind:key="index"
                 class="form-check-inline u-check g-pl-25 ml-0 g-mr-25">
            <input v-bind:id="role.id" v-model="picked" class="g-hidden-xs-up g-pos-abs g-top-0 g-left-0" name="role_id"
                   type="radio" v-bind:value="role.id">
