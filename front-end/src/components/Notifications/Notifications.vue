          ...
          <ul class="list-unstyled mb-0">
            <li class="g-pb-3">
              <router-link
                ...
                v-bind:to="{ name: 'RecivedComments' }">
                <span class="u-icon-v1 g-color-gray-dark-v5 mr-2"><i
                  class="icon-finance-206 u-line-icon-pro"></i></span>
                Comments
                <span v-if="notifications.unread_recived_comments_count"
                      class="u-label g-font-size-11 g-bg-pink g-rounded-20 g-px-8 g-ml-15">{{
                    notifications.unread_recived_comments_count
                  }}</span>
              </router-link>
            </li>
            <li class="g-py-3">
            ...
            <li class="g-py-3">
              <router-link
                class="d-block align-middle u-link-v5 g-color-text g-color-primary--hover g-bg-gray-light-v5--hover rounded g-pa-3"
                v-bind:active-class="'active g-color-primary--active g-bg-gray-light-v5--active'"
                v-bind:to="{ name: 'Follows' }">
                <span class="u-icon-v1 g-color-gray-dark-v5 mr-2"><i
                  class="icon-finance-067 u-line-icon-pro"></i></span>
                Follows
                <span v-if="notifications.unread_follows_count"
                      class="u-label g-font-size-11 g-bg-pink g-rounded-20 g-px-8 g-ml-15">{{
                    notifications.unread_follows_count
                  }}</span>
              </router-link>
            </li>
            <li class="g-py-3">
            ...
            <li class="g-py-3">
              <router-link
                class="d-block align-middle u-link-v5 g-color-text g-color-primary--hover g-bg-gray-light-v5--hover rounded g-pa-3"
                v-bind:active-class="'active g-color-primary--active g-bg-gray-light-v5--active'"
                v-bind:to="{ name: 'FollowingPosts' }">
                <span class="u-icon-v1 g-color-gray-dark-v5 mr-2"><i
                  class="icon-education-008 u-line-icon-pro"></i></span>
                Following Posts
                <span v-if="notifications.unread_followeds_posts_count"
                      class="u-label g-font-size-11 g-bg-pink g-rounded-20 g-px-8 g-ml-15">{{
                    notifications.unread_followeds_posts_count
                  }}</span>
              </router-link>
            </li>
          </ul>
