  ...
  <div>
    ...
    <div class="card border-0 g-mb-15">
      ...
      <div class="card-header d-flex align-items-center justify-content-between g-bg-gray-light-v5 border-0 g-mb-15">
        <h3 class="h6 mb-0">
          <i class="icon-bubbles g-pos-rel g-top-1 g-mr-5"></i> Recived Posts Likes <small v-if="likes">(共
          ...
          <div class="media-body">
            <div class="g-mb-15">
              <h5 class="h5 g-color-gray-dark-v1 mb-0">
                <router-link class="g-text-underline--none--hover" v-bind:to="{ path: `/user/${like.user.id}` }">
                  {{ like.user.name || like.user.username }}
                </router-link>
                <span class="h6">喜欢了你的文章 <router-link class="g-text-underline--none--hover"
                                                      v-bind:to="{ path: `/post/${like.post.id}#like-post` }">《{{
                    like.post.title
                  }}》</router-link></span></h5>
            ...
            <ul class="list-inline d-sm-flex my-0">
              <li class="list-inline-item g-mr-20">
                <span class="u-link-v5 g-color-gray-dark-v4 g-color-primary--hover">
                  <i class="icon-heart g-pos-rel g-top-1 g-mr-3"
                     v-bind:class="{ 'g-color-red': like.post.likers_id.indexOf(sharedState.user_id) != -1 }"></i>
