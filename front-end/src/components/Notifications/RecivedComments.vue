<template>
  <div>
    <!-- Add Comment Form -->
    <form id="replyCommentForm" class="g-mb-40" style="display: none;" @submit.prevent="onSubmitReply"
          @reset.prevent="onResetReply">
      <div class="form-group">
        <textarea id="replyCommentFormBody" v-model="replyCommentForm.body" class="form-control" placeholder=" 评论内容"
                  rows="5"></textarea>
        <small v-show="replyCommentForm.bodyError" class="form-control-feedback">{{
            replyCommentForm.bodyError
          }}</small>
      </div>
    ...
    <div class="card border-0 g-mb-15">
      ...
      <div class="card-header d-flex align-items-center justify-content-between g-bg-gray-light-v5 border-0 g-mb-15">
        <h3 class="h6 mb-0">
          <i class="icon-bubbles g-pos-rel g-top-1 g-mr-5"></i> Recived Comments <small v-if="comments">(共
          ...
          <div class="media-body">
            <div v-if="!comment.parent_id" class="g-mb-15">
              <h5 class="h5 g-color-gray-dark-v1 mb-0">
                ...
                <span class="h6">评论了你的文章<router-link class="g-text-underline--none--hover"
            ...
            <ul class="list-inline d-sm-flex my-0">
              ...
              <ul class="list-inline mb-0 ml-auto">
                <li v-if="!comment.mark_read" class="list-inline-item ml-auto">
                  <a class="u-link-v5 g-color-red g-color-aqua--hover" href="javascript:;"
                     v-on:click="onMarkRead(comment)">
                ...
                <li v-if="!comment.disabled" class="list-inline-item">
                  <button class="btn btn-xs u-btn-outline-purple" v-on:click="onDisabledComment(comment)">屏蔽</button>
                </li>
                <li v-if="comment.disabled" class="list-inline-item">
