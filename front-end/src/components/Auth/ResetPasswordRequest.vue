      ...
      <div class="col-md-4">
        <form @submit.prevent="onSubmit">
          <div class="form-group" v-bind:class="{'u-has-error-v1': resetPasswordForm.emailError}">
            ...
            <input id="email" v-model="resetPasswordForm.email" aria-describedby="emailHelp" class="form-control"
                   placeholder="" type="email">
            <small v-show="resetPasswordForm.emailError" class="form-control-feedback">{{
