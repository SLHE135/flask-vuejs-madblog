      ...
      <div class="col-md-4">
        <form @submit.prevent="onSubmit">
          <div class="form-group" v-bind:class="{'u-has-error-v1': resetPasswordForm.passwordError}">
            ...
            <input id="password" v-model="resetPasswordForm.password" class="form-control" placeholder=""
                   type="password">
            <small v-show="resetPasswordForm.passwordError"
                   class="form-control-feedback">{{ resetPasswordForm.passwordError }}</small>
          </div>
